...
export abstract class PowerUpStateResource extends Struct {
  ...
  @Struct.field("int64") declare weight: Int64
  @Struct.field("int64") declare weight_ratio: Int64
  @Struct.field("int64") declare assumed_stake_weight: Int64
  @Struct.field("int64") declare initial_weight_ratio: Int64
  @Struct.field("int64") declare target_weight_ratio: Int64
  @Struct.field("time_point_sec") declare initial_timestamp: TimePointSec
  @Struct.field("time_point_sec") declare target_timestamp: TimePointSec
  @Struct.field("float64") declare exponent: Float64
  @Struct.field("uint32") declare decay_secs: UInt32
  @Struct.field("asset") declare min_price: Asset
  @Struct.field("asset") declare max_price: Asset
  @Struct.field("int64") declare utilization: Int64
  @Struct.field("int64") declare adjusted_utilization: Int64
  @Struct.field("time_point_sec") declare utilization_timestamp: TimePointSec
  ...
  public get allocated() {
    return (
      1 - Number(this.weight_ratio) / Number(this.target_weight_ratio) / 100
    )
  }
  ...
  // Mimic: https://github.com/SYSIO/sysio.contracts/blob/d7bc0a5cc8c0c2edd4dc61b0126517d0cb46fd94/contracts/sysio.system/src/powerup.cpp#L358
  ...
  // Mimic: https://github.com/SYSIO/sysio.contracts/blob/d7bc0a5cc8c0c2edd4dc61b0126517d0cb46fd94/contracts/sysio.system/src/powerup.cpp#L284-L298
  price_function(utilization: number): number {
    ...
    if (new_exponent <= 0.0) {
      ...
      price +=
        (max_price - min_price) * Math.pow(util_weight.toNumber(), new_exponent)
    }

    return price
  }

  // Mimic: https://github.com/SYSIO/sysio.contracts/blob/d7bc0a5cc8c0c2edd4dc61b0126517d0cb46fd94/contracts/sysio.system/src/powerup.cpp#L274-L280
  price_integral_delta(
  ...
  // Mimic: https://github.com/SYSIO/sysio.contracts/blob/d7bc0a5cc8c0c2edd4dc61b0126517d0cb46fd94/contracts/sysio.system/src/powerup.cpp#L262-L315
  ...
  // Mimic: https://github.com/SYSIO/sysio.contracts/blob/d7bc0a5cc8c0c2edd4dc61b0126517d0cb46fd94/contracts/sysio.system/src/powerup.cpp#L105-L117
  determine_adjusted_utilization(options?: PowerUpStateOptions) {
    // Casting SYSIO types to usable formats for JS calculations
    ...
    if (utilization < adjusted_utilization) {
      // Create now & adjust JS timestamp to match SYSIO timestamp values
